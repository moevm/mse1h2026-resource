...
BUILTIN_EDGE_RULES: List[AutoEdgeRule] = [
    ...
    AutoEdgeRule(
        id="service-to-deployment-selector",
        source_type="Service",
        source_field="selector_app",
        target_type="Deployment",
        target_field="selector_app",
        edge_type="deployedon",
    ),
    AutoEdgeRule(
        id="service-to-deployment-name",
        source_type="Service",
        source_field="deployment_name",
        target_type="Deployment",
        target_field="name",
