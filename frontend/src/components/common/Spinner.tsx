    ...
    <div className="flex flex-col items-center gap-3">
      <div className="relative">
        <svg
          ...
          aria-label="Loading"
        >
          <circle className="opacity-20" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth={strokeMap[size]} />
          <path className="opacity-90" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
        </svg>

        <div
          className={`absolute inset-0 animate-pulse rounded-full bg-blue-500/20 blur-md`}
