...
установле docker compose, локально рекомендуем запускать на ubuntu 22.04, ram:2 gb, свободная память на  устройстве: > 5 gb, ядер: 2 Можно запускать и на хосте с другими характеристиками, лучше на рекомендованных.
