KUBERNETES_API_MAPPING = {
    ...
    "field_mappings": [
        ...
        },
        {
            ...
            "transform_type": "template",
            "transform_config": {"template": "urn:k8s:node:prod:{value}"},
        },
        {
            "id": "node-name",
            "source_path": "metadata.name",
        ...
        {
            "id": "deploy-cluster-id",
            "source_path": "metadata.labels.cluster",
            "target_field": "cluster_id",
            "target_node_type": "Deployment",
            "default_value": "prod-ecommerce",
            "description": "For deployedon edge to RegionCluster",
        },
        {
            "id": "deploy-service",
            "source_path": "metadata.name",
            "target_field": "service_name",
            "target_node_type": "Deployment",
            "description": "For ownedby edge to Service (deployment name = service name)",
        },
        {
            "id": "cluster-id",
            "source_path": "metadata.name",
            "target_field": "id",
            "target_node_type": "RegionCluster",
            "transform_type": "template",
            "transform_config": {"template": "urn:regioncluster:{value}"},
        },
        {
            "id": "cluster-name",
            "source_path": "metadata.name",
        ...
        {
            "id": "cluster-region",
            "source_path": "spec.region",
            "target_field": "region",
            "target_node_type": "RegionCluster",
        },
        {
            "id": "cluster-provider",
            "source_path": "spec.provider",
            "target_field": "provider",
            "target_node_type": "RegionCluster",
        },
        {
            "id": "cluster-id-field",
            "source_path": "spec.cluster_id",
            "target_field": "cluster_id",
            "target_node_type": "RegionCluster",
            "description": "For edge matching from Deployment",
        },
    ],
    "conditional_rules": [
        {
