TERRAFORM_STATE_MAPPING = {
    ...
    "field_mappings": [
        {
            "id": "db-id",
            "source_path": "instances[0].attributes.tags.DisplayName",
            "target_field": "id",
        ...
        {
            "id": "queue-publishers",
            "source_path": "publishers",
            "target_field": "publishers",
            "target_node_type": "QueueTopic",
            "description": "For publishedby edges to Services",
        },
        {
            "id": "queue-consumers",
            "source_path": "consumers",
            "target_field": "consumers",
            "target_node_type": "QueueTopic",
            "description": "For consumedby edges to Services",
        },
        {
            "id": "secret-id",
            "source_path": "instances[0].attributes.name",
    ...
    "conditional_rules": [
        ...
        {
            "id": "cr-sqs-queue",
            "condition": "type == 'aws_sqs_queue'",
            "target_node_type": "QueueTopic",
            "priority": 20,
        },
        {
            "id": "cr-sns-topic",
            "condition": "type == 'aws_sns_topic'",
            "target_node_type": "QueueTopic",
            "priority": 20,
        },
    ],
